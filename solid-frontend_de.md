...
Außerdem ist ein GitHub-Account nötig, um die Resultate problemlos hochladen zu können. Für den Umgang mit Git gibt es eine eigene [Anleitung](solid-git-workflow.md).
